...
const ThemePage: React.FC<ThemePageProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#0a192f] flex flex-col">
      ...
      <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-8 pb-8">
        {themes.map(t => (
          <div
            key={t.id}
          ...
          >
            <div className="w-20 h-20 mb-4 rounded-full flex items-center justify-center bg-[#1e293b] overflow-hidden">
